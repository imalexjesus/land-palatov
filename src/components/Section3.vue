		...
		<div class="l-section-inner l-section-inner--column">
			...
			<div class="c-rectangle-list">
				<div class="c-rectangle-list__item">
					<a class="c-rectangle-list__item-rectangle" uk-toggle  href="#c-modal-urok1">УРОК №1</a>
					<div class="c-rectangle-list__item-text">Введение в курс</div>
				</div>
				<div class="c-rectangle-list__item">
					<a class="c-rectangle-list__item-rectangle" uk-toggle  href="#c-modal-urok2">УРОК №2</a>
				...
				<div class="c-rectangle-list__item">
					<a class="c-rectangle-list__item-rectangle" uk-toggle  href="#c-modal-urok9">УРОК №9</a>
					<div class="c-rectangle-list__item-text">Базовая оптимизация кампании в поисковой сети</div>
				</div>
				<div class="c-rectangle-list__item">
					<a class="c-rectangle-list__item-rectangle" uk-toggle  href="#c-modal-urok10">УРОК №10</a>
